  ...
  function renderSearchResults(results) {
    ...
    searchResults.querySelectorAll('.search-item').forEach(btn => {
      btn.addEventListener('click', () => {
        ...
        statusMsg.textContent = `Loading ${botanical}...`;
        if (currentTab === 'plant') {
